...
class OppositeVehicleRunningRedLight(BasicScenario):
    """
        This class holds everything required for a scenario, in which another vehicle takes priority from the ego vehicle,
    ...
    def create_behavior(self, scenario_init_action):
        ...
        self.x, delta_v, delta_dist = actions  # self.x用来控制对抗车的初始位置
        self.actor_speed = 10 + delta_v  # delta_v 用来控制对抗车的速度
        self.trigger_distance_threshold = 35 + delta_dist  # delta_dist用来控制触发距离
...
class SignalizedJunctionLeftTurn(BasicScenario):
    ...
    def create_behavior(self, scenario_init_action):
        ...
        self._target_vel = 14.0 + delta_v
        self.trigger_distance_threshold = 40 + delta_dist
