...
from safebench.carla_agents.navigation.local_planner import LocalPlanner
from safebench.carla_agents.navigation.global_route_planner import GlobalRoutePlanner
from safebench.carla_agents.tools.misc import get_speed, is_within_distance, get_trafficlight_trigger_location, compute_distance
    ...
    def _affected_by_traffic_light(self, lights_list=None, max_distance=None):
        ...
        for traffic_light in lights_list:
            ...
            if object_waypoint.road_id != ego_vehicle_waypoint.road_id:
                continue
            # 计算自车的前进向量与交通灯的前进向量的点积,如果大于0,则说明夹角小于90度
